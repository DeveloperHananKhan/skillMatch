  ...
  return (
    <>
      ...
      <section className="min-h-screen flex flex-col items-center justify-center bg-black px-4 py-12 border-t-[1px] border-gray-800 border-solid">
        ...
        <div className="w-full max-w-md bg-[#161B22] border border-gray-700 rounded-md shadow-lg p-8 focus:border-[#58A6FF] mt-6">
          ...
          <form className="space-y-5">
            ...
            <div className="flex items-center justify-between text-sm text-gray-400">
              ...
              <a href="#" className="focus:text-[#58A6FF]">
                Forgot password?
              </a>
            </div>
          ...
          <p className="text-sm text-gray-400 mt-6 text-center">
            ...
            <Link to='/register'>
            <span className="text-[#58A6FF] focus:underline  lg:hover:underline">Sign up</span>
            </Link>
          </p>
        </div>
      </section>
