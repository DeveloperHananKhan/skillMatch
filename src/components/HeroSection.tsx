          ...
          <div className="text-center md:text-left">
            ...
            <div className="mt-8 flex justify-center md:justify-start gap-4">
              <button
                ...
                className="bg-[#58A6FF] hover:bg-[#1f6feb] text-white font-semibold py-2 px-6 rounded transition"
              >
                Get Started
              </button>
              <button
                ...
                className="border border-[#58A6FF] text-[#58A6FF] hover:bg-[#1f6feb] hover:text-white font-semibold py-2 px-6 rounded transition"
              >
                How It Works
              </button>
            </div>
